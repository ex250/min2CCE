...
/*
    ...
    hDotPen = CreatePen(PS_SOLID, 1, RGB(255,0,0));
   ...
   // SetMapMode(hDC, MM_LOENGLISH); 
		...
		SetViewportExtEx(hDC, modelWindow.getWidth(),
					...
					NULL);
                float aspect=modelWindow.getWidth()/modelWindow.getHeight();
		SetWindowExtEx(hDC, width, width/aspect, NULL);

		SetWindowOrgEx(hDC,lpPoint->x,lpPoint->y,NULL);
